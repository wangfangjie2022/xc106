...
//	for(int i=0;i<16;i++)
//	{
//		SEGGER_RTT_printf2("%x ",*(AESoutput+i));
//	}
//	SEGGER_RTT_printf2("\r\n");
//	for(int i=16;i<32;i++)
//	{
...
//	}
//	SEGGER_RTT_printf2("\r\n");
//	memset(AESinput+51,0x0D,13);//缺少12个字节，填12
////	utils_aes_crypt_ecb(&cfg,UTILS_AES_ENCRYPT,(unsigned char *)AESinput+48,AESoutput+48); 
//	for(int i=48;i<64;i++)
//	{
//		SEGGER_RTT_printf2("%x ",*(AESoutput+i));
//	}
