...
sd_error_enum sd_block_read(uint32_t *preadbuffer, uint32_t readaddr, uint16_t blocksize)
{
    ...
    if(SD_POLLING_MODE == transmode){
        ...
        while(RESET == dma_flag_get(DMA1, DMA_CH3, DMA_INTF_FTFIF)){
        }
    }else{
        status = SD_PARAMETER_INVALID;
    }
...
#define SDIO_D1_PORT GPIOB
#define SDIO_D2_PORT GPIOB
#define SDIO_D3_PORT GPIOC
#define SDIO_CLK_PORT GPIOC
#define SDIO_CMD_PORT GPIOD

#define SDIO_D0_PIN GPIO_PIN_4
#define SDIO_D1_PIN GPIO_PIN_0
#define SDIO_D2_PIN GPIO_PIN_1
