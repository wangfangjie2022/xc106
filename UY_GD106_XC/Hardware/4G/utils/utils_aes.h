...
/* UTILS_ERR_AES_FEATURE_UNAVAILABLE is deprecated and Shuold not be used. */
#define UTILS_ERR_AES_FEATURE_UNAVAILABLE                                   \
    -0x0023 /**< Feature not available. For example, an unsupported AES key \
               size. */

/* UTILS_ERR_AES_HW_ACCEL_FAILED is deprecated and Shuold not be used. */
...
typedef struct utils_aes_context {
    int       nr;      /*!< The number of rounds. */	//ÂÖÊý
    uint32_t *rk;      /*!< AES round keys. */			//ÂÖÃÜÔ¿
 ...
 *
 * \param ctx      The AES context to which the key Shuold be bound.
 ...
 *         If you need to retain the contents of the IV, you Shuold
